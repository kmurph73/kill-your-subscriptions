...
var AppsView = function (_React$Component) {
  ...
  _createClass(AppsView, [{
    ...
    value: function renderItem(app) {
      ...
      return _react2.default.createElement(
        'div',
        { className: "center-between app-item", key: app.uuid },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { value: amount, type: 'number', className: 'money-box', placeholder: '0.00', onChange: function onChange(e) {
                return _this3.amountInputted(e, app);
              }, onBlur: function onBlur(e) {
                return _this3.amountBlurred(e, app);
              } }),
            _react2.default.createElement(
              'div',
              { className: 'per-what' },
    ...
    value: function renderContent() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactstrap.Button,
            { size: 'sm', onClick: this.clickAddSubscription, outline: true, color: 'primary' },
            'Add Subscription'
          ),
          ' ',
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: 'ml-1', id: 'amount-mode', style: { width: 98 } },
              txt
            )
          )
        ),
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'container', id: 'content', style: { maxWidth: 450 } },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactstrap.Input,
                { type: 'select', name: 'frequency', value: this.state.app.frequency, onChange: this.onInput, style: { width: 100 } },
                _react2.default.createElement(
                  'option',
                  null,
                  'monthly'
              ...
              _react2.default.createElement(_reactstrap.Input, { placeholder: '0.00', className: 'ml-2', type: 'number', name: 'amount', value: this.state.app.blah, onChange: this.onInput })
            ),
            _react2.default.createElement(
              'div',
...
var json_attrs = ['uuid', 'name', 'selected', 'starting_amount_cents', 'current_amount_cents', 'frequency', 'website'];
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function clone() {
      var app = Object.assign(App.blankApp(), this.toJSON());
      delete app.uuid;
    ...
    value: function sumStartingAmountsCents() {
      return (0, _sumBy2.default)(App.getAll(), function (app) {
